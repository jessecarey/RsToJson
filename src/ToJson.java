...
/**
 * Attempt to use simpleJSONS libraries to directly convert a result set to a JSON array.
 * Works, but the ordering of the data in the query is lost and results where generated faster
 * using the factory.
 * @author bpmdev
 *
 */
